...
USER = os.environ.get("USERNAME", "Piyush-Karn")
...
HEAT = ["#0E1724", "#0B3A50", "#0F6C8C", "#00A8CC", "#00D9FF"]
...
<defs>
  ...
  <linearGradient id="beam" x1="0" y1="0" x2="1" y2="0">
    <stop offset="0" stop-color="#7CF9FF" stop-opacity="0"/>
    <stop offset="0.5" stop-color="#7CF9FF" stop-opacity="0.35"/>
    <stop offset="1" stop-color="#7CF9FF" stop-opacity="0"/>
  </linearGradient>
...
def build_stats(d):
    blocks = [
        ...
        (human(d["stars"]), "stars earned"),
        (human(d["followers"]), "followers"),
    ]

    body = ['  <g font-family="Verdana,DejaVu Sans,sans-serif">']
    ...
    body.append(f'    <text x="70" y="66" font-size="13" letter-spacing="2.5" fill="{SUB}">github activity</text>')
    body.append(f'    <line x1="520" y1="50" x2="520" y2="250" stroke="{TRACK}" stroke-width="1"/>')
    body.append(f'    <text x="570" y="66" font-size="13" letter-spacing="2.5" fill="{SUB}">most used languages</text>')
